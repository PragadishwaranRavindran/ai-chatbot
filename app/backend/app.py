...
from directline import setup_directline_routes
...
async def create_app():
    ...
    # Keep the original voice system WebSocket handler
    rtmt.attach_to_app(app, "/realtime")

    # Setup Direct Line routes
    setup_directline_routes(app)

    # Serve static files
    current_directory = Path(__file__).parent
    app.router.add_get('/', lambda _: web.FileResponse(current_directory / 'static/index.html'))
